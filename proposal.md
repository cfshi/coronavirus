...
We will collect data of the following dated from November, 2019 till present (?).
	...
	- science, review of R0 publication from Dec 2019-present: - Science publication: preprint (by searching Google Scholar, arXiv, bioRxiv, medRxiv, and SSRN) and peer-reviewed (by search Google Schoolar, PubMed, Embase, Medline, and OVID)
