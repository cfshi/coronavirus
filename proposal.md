...
# Title
Mapping 2020 novel Coronavirus (COVID-19) outbreak trend: media coverage, the public reaction and understanding and governmental and international response (find a better title?).  
...
To study the following factors and incorporate them all in a model to map a public perception and official guidelines along with patterns of infectious disease (COVID-19 in this case): media (mass and social) coverage, public perception and reaction, institutional decision (governmental and international) and transmission speed/region/scales.  There are two main research questions:

- How do media (mass and social) coverage, public perception and public health guidelines interplay during the outbreak?
	 1. How does the media (mass and social) cover the disease?  We are mainly interested in analyzing cultural dimensions of the epidemic and public health response.  
		* Media content represents what is communicated among the public, the government and the international communities.  It gives stories of what the disease is like and how it is perceived.

	2. How does the general public react to the virus outbreak?
	...
	4. How does the national and international community react to the disease outbreak and with what guidelines (analyzing official websites, such as WHO, CDC, Chinese Center for Disease Control and Prevention, etc) (i.e., analysis of social and policy countermeasures)
