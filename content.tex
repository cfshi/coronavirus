...
Surrogates for public perceptions and behaviour will include twitter data (again) \cs{and Sina Weibo?}; google trends; publicly available box-office information for movies and major sporting leagues; and information \cs{public transportation rides?}about cancellations and shortages (for example of face masks or pharmaceutical or pseudo-pharmaceutical products) from our textual analysis. 
...
\naveed{It depends on objective, would we be doing counter messaging or public health. The way I was envisioning, creating a tool to identify and alert public health communication team and they addressing it through tweets or other means.}
