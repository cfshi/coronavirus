...
\jd{We need to talk about how information spreads from scientists and policy makers to social media (both directly and indirectly). Not sure we need google trends here; we can talk about it nicely in metrics, I hope.}
